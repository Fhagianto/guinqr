                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @if($errors->has('inputKeperluan'))
                                                        <span class="error">{{ $errors->first('inputKeperluan') }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputInstansi">Instansi</label>
                                                        <input
                                                            class="form-control"
                                                            id="inputInstansi"
                                                            name="inputInstansi"
                                                        ...
                                                        @if($errors->has('inputInstansi'))
                                                        <span class="error">{{ $errors->first('inputInstansi') }}</span>
                                                        @endif
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputTujuan">Unit Tujuan</label>
                                                        <select
